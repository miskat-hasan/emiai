...
// export default function DealCard({ deal, role = "influencer" }) {
...
//             </div>
//             <div className="text-right shrink-0">
//               <p className="text-xs font-semibold text-black mb-1">Duration</p>
//               <p className="text-xs font-bold text-black">{deal?.amount}</p>
//             </div>
//           </div>
//         </div>
