...
export const NAV_ITEMS = {
  influencer: [
    ...
    { label: "Portfolio", icon: FolderOpen, href: "/dashboard/influencer/portfolio" },
    ...
    { label: "All Bookmark", icon: Bookmark, href: "/dashboard/influencer/bookmarks" },
    { label: "Events", icon: CalendarDays, href: "/dashboard/influencer/events" },
