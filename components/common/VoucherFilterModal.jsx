...
import { useGetVoucherCategoriesQuery, useGetCountriesQuery } from "@/redux/api/services/voucherApi";
...
export default function VoucherFilterModal({ open, onClose, onFilter, role = "influencer" }) {
  // Fetch from backend
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 overflow-y-auto scrollbar-thin scrollbar-thumb-primary/20 scrollbar-track-transparent">
          ...
          >
            <h2 className="text-xl font-bold text-black mb-1">Vouchers Filter</h2>

            <div className="border-t border-gray-200 -mx-2" />

            <div className="flex flex-col gap-5">
              <Field label="Filter By Categories" error={errors.category_id?.message}>
                <div className="relative">
                  ...
                  >
                    <option value="" disabled hidden>Restaurants</option>
                    {categories.map(cat => (
              ...
              <Field label="Country" error={errors.country_id?.message}>
                <div className="relative">
                  <select
                    ...
                    className="w-full rounded-xl bg-gray-50 border border-transparent px-4 py-3.5 text-[15px] text-black outline-none focus:border-primary/40 focus:bg-white transition-all appearance-none cursor-pointer"
                  >
                    <option value="" disabled hidden>Bangladesh</option>
              ...
              <Field label="Publisher Name" error={errors.publisher_name?.message}>
                <Input
