...
export default function ImageGenerationPage({ role }) {
  ...
  return (
    <div className="flex flex-col items-center gap-8 max-w-3xl mx-auto py-4 font-dm-sans">
      {/* Heading */}
      <div className="text-center w-full flex flex-col items-start lg:items-center">
