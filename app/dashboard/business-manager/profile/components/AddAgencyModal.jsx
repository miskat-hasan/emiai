          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <input 
                type="text" 
                placeholder="here....." 
                className="w-full bg-[#F1EDE7] text-sm text-gray-700 px-4 py-3 rounded-xl focus:outline-none placeholder:text-gray-400/70"
              />
            </div>
            <div className="space-y-1.5">
            ...
            <div className="flex items-center justify-between sm:pt-6 px-1">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                  isExclusive ? "bg-gradient-to-r from-[#FF5C26] to-[#FF7A45]" : "bg-gray-200"
                }`}
              >
                <span
