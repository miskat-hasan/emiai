...
export default function PortfolioCard({ item }) {
  return (
<div className="rounded-2xl border border-[#E5E6E6] p-4">
        <div className="overflow-hidden   bg-white transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
