...
export default function BlockModal({ isOpen, onClose, userName }) {
  if (!isOpen) return null;

  const handleBlock = () => {
    toast.success(`Blocked ${userName} successfully.`);
    onClose();
  };
      ...
      <div className="relative w-full max-w-[400px] bg-white rounded-3xl overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <div className="relative flex flex-col items-center px-8 py-10 text-center z-10">
          ...
          <p className="text-sm text-gray-500 mb-8 px-2">
            Are you sure you want to block <span className="font-semibold text-gray-700">"{userName}"</span>?
          </p>
