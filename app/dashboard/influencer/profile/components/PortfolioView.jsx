...
const profilePortfolioItems = [
  {
    ...
    details: "Comprehensive bike ad campaigns showcasing freedom and lifestyle.",
    image: "https://images.unsplash.com/photo-1558981806-ec527fa84c39?w=700&h=520&fit=crop",
    likes: "23k",
    views: "23k",
  },
  {
    ...
    details: "High engagement mobile ad campaigns built for native social feeds.",
    image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=700&h=520&fit=crop",
    likes: "22k",
    views: "21k",
  },
  {
    ...
    details: "Portfolio for live event branding, experiential activation, and design.",
    image: "https://images.unsplash.com/photo-1529139574466-a303027c1d8b?w=700&h=520&fit=crop",
    likes: "20k",
    views: "19k",
  },
];
    ...
    <div className="space-y-6">
      ...
      {profilePortfolioItems.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 bg-gray-50/50 rounded-3xl border-2 border-dashed border-gray-100">
          <p className="text-gray font-medium text-sm">No portfolio items found.</p>
        </div>
      )}
