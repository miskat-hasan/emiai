...
export default function EventParticipants() {
  return (
    <div className="bg-gray-50 rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100">
      <h2 className="text-lg font-bold text-gray-900 mb-5">Participants</h2>

      <hr className="my-5 border-gray-200" />

      {/* Scrollable Container */}
      <div className="max-h-96 overflow-y-auto no-scrollbar pr-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
